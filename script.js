...
React.createElement('div',{style : {
    ...
    React.createElement('h1',{style : {margin : "0px",padding : "0px",opacity:'.7'}},"Rushikesh Dhanawade"),
...
React.createElement('div',{style : {
    ...
    React.createElement('p',{style : {margin : "0",padding : "0",alignItems:'center',fontSize:'1.7rem'}},"170"),
    React.createElement('p',{style : {margin : "0",paddingRight : "15px",fontSize:'1.7rem'}},"20"),
    React.createElement('p',{style : {margin : "0",paddingRight : "15px",alignItems:'center',fontSize:'1.6rem'}},"15K"),
